...
public class ImageScaleTest {
    ...
    public ImageScaleTest() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.add(new TestPane(frame.getWidth(),frame.getHeight()));
            }
        });
    }
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane(int Width, int Height) {
            ...
            this.Height=Height;
            try {
                original = ImageIO.read(new File("D:/Repositorios/Parqueadero/ParqueaderoFuncional/src/IMG/parking.png"));
//                scaled = original.getScaledInstance(original.getWidth() / 2, original.getHeight() / 2, Image.SCALE_DEFAULT);
//JFrame topFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
                
scaled = original.getScaledInstance( this.Width, this.Height, Image.SCALE_DEFAULT);
